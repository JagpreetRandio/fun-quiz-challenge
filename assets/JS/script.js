...
const questions = [{
  ...
  answers: [ "Colorful Style Sheet",  "Comp Style Sheet", "Cascades Styling Sheet", "Cascading Style Sheet"], 
  ...
  answers: ["Hypertext Markup Language", "Hypertech Markup Language", "HorizionText Marked Languages",  "Haakontext Markup Language"], 
  correctAnswer: "Hypertext Markup Language"
}, {
  question: "Which is not a data type?",
  answers: ["Booleans", "Numbers", "Alerts",  "Undefined"], 
  correctAnswer: "Alerts"
}, {
  question: "How do you create a function in Javascript?",
  answers: ["thisFunction()", "create.Function()", "function thisFunction()",  "function= thisFunction()"], 
  correctAnswer: "function thisFunction()"
}, {
  question: "Inside the HTML, which element do we put the Javascript?",
  answers: ["<addscript>", "<js-script-file>", "<JAVASCRIPT-FILE>",  "<script>"], 
  correctAnswer: "<script>"
},{
  question: "The first index of an array is ____?",
  answers: ["1", "0", "A",  "All choices are correct"], 
  correctAnswer: "0"
},{
  question: "How do you make a comment tag in a HTML file?",
  answers: ["//comment", "<!--comment-->", "{comment}", "--!comment!--"],
  correctAnswer: "<!--comment-->"
},{
  question: "What are the three main languages used to build a website?",
  answers: ["BootStrap, HTML, CSS", "CSS, Javascript, HTML", "Javascript, Bootstrap, jQuery", "CSS, HTML, C++"],
  correctAnswer: "CSS, Javascript, HTML"
}, {
  question: "What is Javascript used for?",
  answers: ["Scripting language used to create dynamic websites", "Scripting language used only to create clip art", "Scripting language used to static websites where content cannot be changed", "Scripting language is only used for adding numbers and math problems to a website"],
correctAnswer: "Scripting language used to create dynamic websites"
}
];

const timerEl = document.getElementById("timer");

// all buttons for quiz
